...
export default function SiteSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
        ...
        <SidebarGroup>
          <SidebarGroupContent className="flex flex-col gap-2">
            ...
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton>
                  <SidebarItem label="Search" icon={SearchIcon} isSearch onClick={search.onOpen} />
                </SidebarMenuButton>
              </SidebarMenuItem>
              {/* settings */}
              <SidebarMenuItem>
                <SidebarMenuButton>
                  <SidebarItem label="Settings" icon={SettingsIcon} onClick={settings.onOpen} />
                </SidebarMenuButton>
              </SidebarMenuItem>
              {/* new note page */}
              <SidebarMenuItem>
                <SidebarMenuButton>
                  <SidebarItem onClick={handleCreate} label="New Page" icon={PlusCircleIcon} />
                </SidebarMenuButton>
              </SidebarMenuItem>
              {/* notes document list */}
              <SidebarMenuItem>
